...
feeds = [
    'https://sasktoday.ca/rss/north/newsletter-north',
    'https://sasktoday.ca/rss/central/newsletter-central',
    'https://sasktoday.ca/rss/southwest/newsletter-southwest',
    'https://sasktoday.ca/rss/southeast/newsletter-southeast',
    'https://sasktoday.ca/rss/sk-rss-newsletter'
]
...
def format_email_report(duplicates, all_items, seen):
    ...
    body += "<h2>SaskToday Main Newsletter - Duplicate Article Check</h2>"
...
def run_monitor():
    ...
    # Send the email
    send_email("Duplicate Article Check - SaskToday Newsletter", email_body)
